        ...
        "columns": [
            ...
            { "data": "precio" },
            {
                "data": "esActivo", render: function (data) {
                    if (data == 1) {
                        return '<span class="badge badege-info">Activo</span>'
                    }
                    else {
                        return '<span class="badge badege-danger">No Activo</span>'
                    }
                }
            },
...
$("#btnGuardar").click(function () {
    ...
    if (inputs_sin_valor.length > 0) {
        const mensaje = `Debe completar campo : "${inputs_sin_valor[0].name}"`;
    ...
    modelo["descripcion"] = $("#txtDescricpion").val()
    ...
    $("#modelData").find("div.modal-content").LoadingOverlay("show");

...
public partial class DbventaContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdCategoria).HasName("PK__Categori__8A3D240C7EDBFF8A");
        ...
        {
            entity.HasKey(e => e.IdDetalleVenta).HasName("PK__DetalleV__BFE2843FE3DE3340");
        ...
        {
            entity.HasKey(e => e.IdMenu).HasName("PK__Menu__C26AF483C700EE4A");
        ...
        {
            entity.HasKey(e => e.IdNegocio).HasName("PK__Negocio__70E1E1073EF8A47A");
        ...
        {
            entity.HasKey(e => e.IdNumeroCorrelativo).HasName("PK__NumeroCo__25FB547E6C9CB2C8");
        ...
        {
            entity.HasKey(e => e.IdProducto).HasName("PK__Producto__07F4A132E710A9E9");
        ...
        {
            entity.HasKey(e => e.IdRol).HasName("PK__Rol__3C872F76EB318DAC");
        ...
        {
            entity.HasKey(e => e.IdRolMenu).HasName("PK__RolMenu__CD2045D82C9AF2F7");
            ...
            entity.HasOne(d => d.IdMenuNavigation).WithMany(p => p.RolMenus)
                ...
                .HasConstraintName("FK__RolMenu__idMenu__403A8C7D");

            entity.HasOne(d => d.IdRolNavigation).WithMany(p => p.RolMenus)
                .HasForeignKey(d => d.IdRol)
                .HasConstraintName("FK__RolMenu__idRol__3F466844");
        });

        modelBuilder.Entity<TipoDocumentoVenta>(entity =>
        {
            entity.HasKey(e => e.IdTipoDocumentoVenta).HasName("PK__TipoDocu__A9D59AEEDEC2DCB4");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__645723A6247AEF9D");
        ...
        {
            entity.HasKey(e => e.IdVenta).HasName("PK__Venta__077D56145EF92E50");
